...
class OneTimeJobController extends Controller
{
    public function create()
    {
        ...
        return view('manager.one_time_job.create', compact('managerAndStaffs'));
    }
    ...
    public function createByStaff()
    {
        ...
        return view('staff.one_time_job.create', compact('managerAndStaffs'));
    }
    ...
    public function getDataByStaff(Request $request)
    {
        $authUserId = (string) auth()->id();
