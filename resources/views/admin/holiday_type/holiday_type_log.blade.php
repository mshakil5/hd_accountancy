...
<section class="content" id="contentContainer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <a href="{{ route('allHolidayType') }}" class="btn btn-secondary mb-3">
                    <i class="fas fa-arrow-left"></i> Back
                </a>

                <div class="card card-secondary border-theme border-2">
                    <div class="card-header">
                        <h3 class="card-title">Holiday Type Log</h3>
                    </div>
                    <div class="card-body">
                        <table id="holidayTypeLogTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Sl</th>
                                    <th>Date</th>
