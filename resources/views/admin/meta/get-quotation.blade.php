      ...
      <div class="col-md-10">
        <div class="card card-secondary border-theme border-2">
          <div class="card-header">
            <h3 class="card-title">Get Quotation Page Meta Data</h3>
          </div>
          <div class="card-body">
            @if(session('success'))
            ...
            @endif
              ...
              <div class="ermsg"></div>
              <form id="updateThisForm" action="{{ route('getQuotationMeta.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
