<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        @if (in_array('7', json_decode(Auth::user()->role->permission)) ||
            ...
            {{ request()->routeIs(
                ...
                {{ request()->routeIs(
                    ...
                    ? 'active'
                    : '' }}"
                    href="#" data-bs-toggle="collapse" data-bs-target="#clientModule"
        ...
        <li
            ...
            <ul id="reportDropdown"
                class="collapse list-unstyled {{ request()->routeIs('report.create') || request()->routeIs('client-acquisition-report') || request()->routeIs('client.fees-report') || request()->routeIs('attendance.report') ? 'show' : '' }}">
