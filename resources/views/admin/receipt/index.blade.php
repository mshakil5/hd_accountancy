            ...
            <div class="card modern-card mt-3">
                <div class="card-body">
                    <div class="row mb-4 align-items-end">
                        <div class="col-md-3"><label>Status</label><select class="form-control" id="filterStatus">
                        ...
                        <div class="col-md-3"><label>Payment</label><select class="form-control" id="filterPaid">
                                <option value="">All</option>
                                <option value="yes">Paid</option>
                                <option value="no">Unpaid</option>
                            </select></div>
                        <div class="col-md-3"><label>Method</label><select class="form-control" id="filterPaymentMethod">
                                <option value="">All</option>
                                <option value="cash">Cash</option>
                                <option value="bank">Bank</option>
                                <option value="card">Card</option>
                            </select></div>
                        <div class="col-md-3"><button class="btn btn-secondary btn-block" id="resetFilter"><i
