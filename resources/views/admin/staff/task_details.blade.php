                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" id="sequence_status" @if ($service->sequence_status == 1 || $service->sequence_status == 0) disabled @endif>
                                    ...
                                    <td>
                                        <button class="btn btn-primary update-btn" data-service-id="{{ $service->id }}" @if ($service->sequence_status == 1 || $service->sequence_status == 0) disabled @endif>Update</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
