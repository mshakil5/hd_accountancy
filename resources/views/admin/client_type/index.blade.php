    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          <div class="card card-secondary border-theme border-2">
            <div class="card-header">
              <h3 class="card-title">All Client Types</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center">
                        <a href="{{ route('client.type.activities', $data->id) }}" class="btn btn-link">
...
<script>
  $(document).ready(function () {
      ...
      //
      var url = "{{URL::to('/admin/client-type')}}";
      var upurl = "{{URL::to('/admin/client-type-update')}}";
      // console.log(url);
