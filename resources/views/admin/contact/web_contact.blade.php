                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <img id="meta_image_preview" src="{{ old('meta_image', asset('images/meta_image/' . $contactHeading->meta_image)) }}" alt="Banner Image Preview" class="pt-3" style="max-width: 250px; height: auto;"/>
                    </div>
                  </div>
                </div>
              </form>
