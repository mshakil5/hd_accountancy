              ...
              <table id="example1" class="table cell-border table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center"><img src="{{ $data->image }}" style="max-width: 100px; height: auto;" alt="image"></td>
...
<script>
  $(document).ready(function () {
      ...
      var url = "{{URL::to('/admin/case-studies')}}";
      var upurl = "{{URL::to('/admin/case-studies-update')}}";
      // console.log(url);
