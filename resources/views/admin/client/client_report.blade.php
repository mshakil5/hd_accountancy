<form id="detailsForm">
    <div class="row my-4">
        ...
        <div class="col-lg-3 text-center">
            <div class="img mb-2">
                <img src="{{ $client->photo ? asset('images/client/' . $client->photo) : asset('assets/img/human-placeholder.jpg') }}"
                    id="imagePreview" width="150" class="border-theme border-2 rounded-3">
            </div>
        </div>
                    ...
                    <div class="col-lg-6 d-flex flex-column">
                        <table class="w-100 text-capitalize" style="table-layout: fixed;">
                            ...
                            <tr>
                                ...
                                <td><span>{!! $client->businessInfo->vat_authorization !== null
                                    ? ($client->businessInfo->vat_authorization == 1
                                        ? 'Yes'
                                        : 'No')
                                    : '&nbsp;' !!}
                                    </span></td>
                            ...
                            <tr>
                                ...
                                <td><span>{{ $client->businessInfo->year_end_date
                                    ?? ''}}
                                    </span></td>
                            </tr>
                            <tr>
                                <td><b>Confirmation Date:</b></td>
                                <td><span>{{ $client->businessInfo->confirmation_due_date
                                    ?? ''}}
                                    </span></td>
                            </tr>
                        </table>
                        ...
                        <div class="col-lg-6">
                            <table class="w-100 text-capitalize" style="table-layout: fixed; width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 50%; vertical-align: top;"><span>{{ $loop->iteration }}</span>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-lg-6">
                        ...
                        <ol class="list-unstyled">
                            @foreach ($approvedServices as $key => $service)
                                @if ($key % 2 == 0)
                                    <li>{{ $number++ }}.
                                        {{ $service->service ? $service->service->name : '&nbsp;' }}</li>
                                @endif
                            @endforeach
                        </ol>
                    </div>
                ...
                <div class="row px-3 my-2 txt-theme">
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9">
                                {!! $client->accountancyFee->next_review
                                    ? \Carbon\Carbon::parse($client->accountancyFee->next_review)->format('d-m-Y')
                                    : '&nbsp;' !!}
                            </div>
                        </div>
                        <div class="row mb-2">
