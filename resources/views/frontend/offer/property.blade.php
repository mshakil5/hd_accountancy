...
<head>
    ...
    <script>
        ...
        fbq('init', '2238601653293836');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=2238601653293836&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <section class="discount-section" id="discount">
        <div class="container">
            ...
            <h3 class="discount-subtitle">to get your property account sorted</h3>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control @error('message') is-invalid @enderror" rows="5" name="message">{{ old('message') }}</textarea>
                                    @error('message')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
            ...
            <div class="row g-4" style="
                ...
                <div class="col-lg-4">
                    <div class="pricing-card growth">
                        <div class="pricing-badge-growth">Property Account, Tax and Compliance</div>
                        <div class="pricing-turnover">Ideal for landlords</div>
                        ...
                        <ul class="pricing-features">
                            <li><span class="iconify" data-icon="mdi:check-circle"></span> Prepare Property Account</li>
                            <li><span class="iconify" data-icon="mdi:check-circle"></span> Complete and submit Self Assesment to HMRC</li>
                            <li><span class="iconify" data-icon="mdi:check-circle"></span> All relevant Tax Services</li>
                        </ul>
