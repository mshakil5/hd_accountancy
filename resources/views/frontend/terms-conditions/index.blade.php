        ...
        <div class="row py-5">
            <div class="col-lg-12">
                <div class="text-center w-100  mx-auto">
                    <div class=" px-5">
                        <h1 class="text-light poppins-bold">{{ $termsConditions->short_title }}</h1>
                    </div>
                    <p class="text-light w-75 text-center my-3 mx-auto">
                        {{ $termsConditions->long_title }}
                    </p>
                </div>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="row py-2 col-lg-12 mx-auto py-3">
            <h1 class="txt-primary text-center text-capitalize poppins-bold mb-5">{{ $termsConditions->short_description }}</h1>
            {!! $termsConditions->long_description !!}
