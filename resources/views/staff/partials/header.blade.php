    ...
    <div class="menuBar p-1 ps-4">
      ...
      <div class="row mx-0">
        ...
        <div class="col-lg-6 justify-content-end d-flex align-items-center pe-3">
          <i class="bi bi-clock fs-4 txt-theme mx-2" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#timeModal1"></i><span class="fw-bold txt-theme fs-6" title="Clock Out">Clock Out</span>
